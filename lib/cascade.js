...
export async function lockVault({ vaultfile, entries, hep, rows, n }) {
	const salt = crypto.randomBytes(16)
	const materials = deriveMaterials(hep, salt, rows, n)
...
export async function openVault({ vaultfile, outdir, salt, hep, rows, n }) {
	const materials = deriveMaterials(hep, salt, rows, n)
